...
export class CartAddComponent implements OnInit {
    ...
    onItemAddClick(item: any) {
        console.log("On onItemAddClick clicked");
        console.log("Quyen debug: item: ", item);
        var value = (<HTMLInputElement>document.getElementById(item.id)).value;
        console.log("Quyen debug: value: ", value);
        item.quantity = parseInt(value.toString());

        this.CartList.push(item);
        console.log("Quyen debug: CartList: ", this.CartList);
        this.localStorage.SetCartListItems(this.CartList);
    ...
    onBackToCartClick() {
        console.log("On onBackToCartClick clicked");
